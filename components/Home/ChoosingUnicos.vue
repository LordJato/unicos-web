<template>
    <section id="choosingUnicos">
        <VContainer class="h-100 px-0" fluid>
            <h1 class="text-h4 text-center mb-8">Why do our partners choose Unicos?</h1>
            <VRow class="h-100 pb-16">
                <VCol cols="12" md="6">
                    <VRow class="h-100 d-flex justify-center justify-md-end">
                        <VCol cols="9" class="ps-md-6 pe-md-14">
                            <div class="text-h6 mb-5">
                                <span class="font-weight-bold" >First</span>, Unicos ensures data protection and confidentiality through robust security
                                measures.
                                Additionally, it offers global accessibility for secure access anywhere, anytime.
                            </div>
                            <VRow>
                                <VCol cols="12" md="6">
                                    <VCard class="rounded-xl text-center py-3" elevation="6">
                                        <VCardText>
                ...
                <VCol cols="12" md="6">
                    <VRow class="h-100 d-flex justify-center justify-md-start">
                        <VCol cols="9" class="ps-md-16">
                            <div class="text-h6 mb-5">
                                <span class="font-weight-bold" >Second</span>, Unicos revolutionizes business growth. Our innovative platform offers:
                            </div>
                            <div>
